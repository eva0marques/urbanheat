...
test$info <- add_post_to_info(test$mod_joint, test$info)
...
plot_obs_int(test$info)
plot_hyperprec(test$mod_joint, test$info)
plot_beta_covar(test$info)
```
...
```{r}
add_post_to_info(test$mod_joint)
plot_marginals_joint(test$mod_joint)
